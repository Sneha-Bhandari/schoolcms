...
export default function CurriculumTopSection() {
  ...
  const handleUpdate = async (values, { resetForm }) => {
    ...
    toast.success("Curriculum Details Section updated locally!");
  ...
  return (
    <div className="md:my-16 my-12">
        ...
        <div className="md:w-fit  flex flex-col items-start justify-start  md:ml-16 ml-4 mb-8">
          <h3 className="text-xl font-semibold underline mb-2">Curriculum Top Section</h3>
          <p className="text-sm text-gray-500">
            Update the title and description for the curriculum top section.
          </p>
        </div>
                  ...
                  {!showUpdateForm ? (
                    <>
                      ...
                      <div className="flex  ">
                        ...
                        >
                          Update Curriculum Top Section Details
                        </button>
                      </div>
                    </>
                  ) : (
