...
const AcademicProgramTopSection = () => {
      ...
      <div className="md:w-10/15 w-full">
        <Formik
          ...
          onSubmit={(values) => {
            ...
            console.log("Academic Program Top Section Data:", values);
          }}
        >
...
export default AcademicProgramTopSection;
