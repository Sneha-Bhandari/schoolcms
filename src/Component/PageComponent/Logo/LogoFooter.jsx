        ...
        <Formik
          ...
          onSubmit={async (values, { resetForm }) => {
            try {
              ...
              toast.success(
                isEdit
                  ? "Footer logo updated successfully"
                  : "Footer logo uploaded successfully"
              );
              if (!isEdit) resetForm();
            } catch {
        ...
        >
          {({ values, setFieldValue }) => (
            <Form className="flex flex-col gap-6">
              <div>
                <label className="font-semibold flex">Footer Logo *</label>
                ...
                >
                  {values.footerLogo ? (
                    <img
                      src={
                        values.footerLogo instanceof File
                          ? URL.createObjectURL(values.footerLogo)
                          : values.footerLogo
                      }
                ...
                <input
                  ...
                  className="hidden"
                  onChange={(e) =>
                    setFieldValue("footerLogo", e.target.files[0])
                  }
                />
