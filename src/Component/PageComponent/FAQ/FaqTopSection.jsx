  ...
  return (
    <div className="my-12">
        ...
        <div className="md:w-fit  flex flex-col items-start justify-start  md:ml-16 ml-8 mb-8">
          <h3 className="text-xl font-semibold underline mb-2">FAQ Top Section</h3>
          <p className="text-sm text-gray-500">
            Update the title and description for the Faq top section.
          </p>
        </div>
                  ...
                  {!showUpdateForm ? (
                    <>
                      ...
                      <div className="flex  ">
                        ...
                        >
                          Update FAQ Top Section Details
                        </button>
                      </div>
                    </>
                  ) : (
