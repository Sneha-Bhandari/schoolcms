      ...
      <div className="md:w-10/15 w-full">
        <Formik
          ...
          onSubmit={(values) => {
            ...
            console.log("Admission Banner Data:", values);
        ...
        >
          {({ values, setFieldValue }) => (
            <Form className="flex flex-col gap-4 shadow-2xl shadow-blue-100 md:p-12 p-8 rounded-xl">
              ...
              <button
                type="submit"
                className="bg-linear-to-r from-[#0B0C28] to-cyan-400font-semibold text-white py-2.5 px-4 w-fit rounded-xl cursor-pointer duration-500 transition-colors"
              >
                {hasData ? "Update Admission Banner" : "Create Admission Banner"}
              </button>
            </Form>
          )}
        </Formik>
