        ...
        <Formik
          ...
          onSubmit={async (values, { resetForm }) => {
            try {
              ...
              console.log("Curriculum Banner Data:", values);
              toast.success(
                isEdit
                  ? "Curriculum Banner updated successfully!"
                  : "Curriculum Banner created successfully!"
              );
            ...
            <Form className="flex flex-col gap-4 shadow-2xl shadow-blue-100 md:p-12 p-8 rounded-xl">
              ...
              >
                ...
                {loading
                  ? "Please wait..."
                  : isEdit
                  ? "Update Curriculum Banner"
                  : "Create Curriculum Banner"}
              </button>
            </Form>
          )}
        </Formik>
