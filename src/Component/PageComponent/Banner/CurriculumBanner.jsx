...
const defaultData = {
  ...
  description:
    "This shows curriculum activities of all grades",
};

export default function CurriculumBanner({ initialData }) {
  ...
  return (
    <div className="my-16 ">
      <div className=" flex flex-col items-start justify-start mb-8">
        <h3 className="text-xl font-semibold underline mb-2">Curriculum Banner Section</h3>
      ...
      {!editMode ? (
        <div className="w-full rounded-xl shadow-2xl p-6 flex flex-col gap-4 ">
          ...
          >
            Update Curriculum Banner          </button>
        </div>
      ) : (
